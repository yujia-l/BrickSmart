...
def finite_ledger(**quantities):
    """Return finite ledger.
    
    :param quantities: The quantities value.
...
def test_atomic_reservation_does_not_partially_consume_stock():
    """Test that atomic reservation does not partially consume stock."""
...
def test_release_restores_reserved_stock():
    """Test that release restores reserved stock."""
...
def test_commit_moves_reserved_to_committed():
    """Test that commit moves reserved to committed."""
