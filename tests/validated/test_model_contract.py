...
def write_contract_fixture(
    ...
    *,
    ...
    :param provisional: The provisional value.
    :type provisional: bool
    :param object_type: The object type value.
...
def test_generic_contract_accepts_unlisted_object_type(tmp_path: Path, catalog_csv: Path) -> None:
    """Test that generic contract accepts unlisted object type.
    ...
    context, confirmations, _ = write_contract_fixture(
        tmp_path, catalog_csv, object_type="excavator_test_rig"
    )
...
def test_provisional_contract_is_rejected(tmp_path: Path, catalog_csv: Path) -> None:
    """Test that provisional contract is rejected.
    ...
    :type catalog_csv: Path
    """
    context, _, _ = write_contract_fixture(tmp_path, catalog_csv, provisional=True)
...
def test_registry_selects_capability_not_model_name() -> None:
    """Test that registry selects capability not model name."""
...
def test_semantic_group_can_survive_member_merge() -> None:
    """Test that semantic group can survive member merge."""
    context = {
        "segment_semantics": {
            "source_segment_groups": [{
...
def test_exact_source_member_group_detects_loss() -> None:
    """Test that exact source member group detects loss."""
    context = {
        "segment_semantics": {
            "source_segment_groups": [{
...
def test_checkpoint_comparison_ignores_absolute_paths() -> None:
    """Test that checkpoint comparison ignores absolute paths."""
    expected = {
...
def test_normalized_context_preserves_multiple_motion_subassemblies() -> None:
    """Test that normalized context preserves multiple motion subassemblies."""
