"""Compatibility inventory loader and validation helpers.

This module supports legacy imports for reading and checking inventory profiles
against catalog block identifiers.
"""
...
def validate_inventory_profile(
    ...
    :type profile: InventoryProfile
    :param catalog_families: The catalog families value.
    :type catalog_families: Iterable[str]
    :returns: The result produced by the function.
    :rtype: dict[str, Any]
    """
    ...
    if unknown_inventory_families:
        raise KeyError(
            "Inventory profile contains block families absent from block_definitions.csv: "
...
def block_family_counts(blocks: Iterable[Any], multiplier: int = 1) -> dict[str, int]:
    """Return block family counts.
    
    :param blocks: Block records used by the operation.
    :type blocks: Iterable[Any]
...
class InventoryLedger:
    ...
    def reserved_totals(self) -> dict[str, int]:
        """Return the reserved totals value.
    ...
    def reserve_and_commit(self, requirements: Mapping[str, int], scope: str) -> str:
        """Return the reserve and commit value.
    ...
    def _record_event(
        ...
        :param event_type: The event type value.
        :type event_type: str
        :param scope: The scope value.
        :type scope: str
        :param requirements: The requirements value.
        :type requirements: Mapping[str, int]
        :param shortages: The shortages value.
        :type shortages: Mapping[str, Any]
        """
        self._event_index += 1
        self._events.append({
