"""Pydantic request and response models for the BrickSmart API.

The models define the structured service boundary between frontend workflows,
contract submission, planning requests, and runtime responses.
"""
...
class ObjPlanRequest(BaseModel):
    ...
    catalog_path: str = "block_catalog/block_definitions.csv"
