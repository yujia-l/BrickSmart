"""Geometry loading, voxelization, and source-lineage package.

The package contains deterministic geometry helpers shared by validated and
experimental planning paths.
"""
