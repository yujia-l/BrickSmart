"""Command-line interface for validated BrickSmart builds.

The CLI parses contract, inventory, and run-output options and then invokes the
model-agnostic backend build runner.
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Build any BrickSmart model from a task-context contract and the shared CSV catalog."
    )
