...
This module checks placement collisions, coverage, coordinates, and final-part
...
def validate_voxel_build(
    *,
    ...
    :param coverage_target: The coverage target value.
    :type coverage_target: float
