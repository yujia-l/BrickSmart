"""Structural voxel packing planner.

This module converts source voxels into catalog-backed block placements while
preserving geometry, connectivity, and inventory constraints.
"""
...
class InventoryConstrainedVoxelPlanner:
    def __init__(
        ...
        """Initialize the InventoryConstrainedVoxelPlanner instance.
        ...
        :type config: StructuralPlannerConfig | None
        """
        self.ledger = ledger
    ...
    def plan(self, voxel_model: VoxelModel) -> tuple[
        ...
        :type voxel_model: VoxelModel
        :returns: The result produced by the function.
        :rtype: tuple[list[SelectedVoxelBlock], list, PlanningResult, dict[str, object], dict[str, object]]
        """
