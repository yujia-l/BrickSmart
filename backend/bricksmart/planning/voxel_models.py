"""Voxel-planning data models.

This module defines typed containers for voxel grids, coordinates, structural
blocks, segment voxels, and planner results.
"""
...
class SelectedVoxelBlock:
    ...
    def to_placement(self, *, step: int | None = None) -> Placement:
        """Convert the object to placement.
