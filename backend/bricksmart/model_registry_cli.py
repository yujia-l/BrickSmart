"""Command-line interface for model-contract registry operations.

This module exposes contract lookup, validation, current-revision inspection,
and registry-oriented maintenance commands.
"""
