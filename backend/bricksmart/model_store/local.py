"""Local filesystem model-store implementation.

This module imports model bytes, stores checksum-addressed objects, writes
manifests, and resolves local model references.
"""
...
def sha256_stream(handle: BinaryIO) -> tuple[str, int]:
    """Compute SHA-256 for stream.
    
    :param handle: The handle value.
    :type handle: BinaryIO
...
def safe_model_id(value: str) -> str:
    """Return the safe model id value.
...
class LocalModelStore:
    ...
    def __init__(self, root: str | Path, *, max_bytes: int = 512 * 1024 * 1024):
        """Initialize the LocalModelStore instance.
        
        :param root: The root value.
        :type root: str | Path
        :param max_bytes: The max bytes value.
        :type max_bytes: int
        """
    ...
    def _manifest_path(self, model_id: str) -> Path:
        """Return the manifest path value.
    ...
    def import_file(
        ...
        *,
        ...
        :param original_filename: The original filename value.
        :type original_filename: str | None
        :param media_type: The media type value.
        :type media_type: str
        :returns: The result produced by the function.
        :rtype: ModelRecord
        """
