"""Legacy planning command-line entry point.

This module preserves the older BrickSmart planner command while the validated
contract-driven build CLI provides the preferred runtime path.
"""
