"""Execution-policy checks for validated and exploratory modes.

This module prevents provisional LLM-assisted behavior from being treated as a
validated deterministic build.
"""
