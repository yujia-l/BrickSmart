"""Inventory compiler for run-level quantities.

This module validates inventory profiles against the catalog and prepares typed
quantities for planning and final recount validation.
"""
